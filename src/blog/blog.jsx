...
function BlogCard(props) {
    return (
        <div className="blog-card">
            ...
            <div className='blog-card-user-container'>
                <p>{props.user}</p>
            </div>
